...
describe('User', function() {
  let user;
  beforeEach(() => {
    user = new User(userSampleData[0], sleepSampleData)
  })
  ...
  it('should have a default sleepRepository of []', function() {
    expect(user.sleepRepository).to.deep.equal([]);
  });
